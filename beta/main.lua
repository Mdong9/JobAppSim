...
function initializeUpgradeValues()
    for i=1,7 do
...
function drawUpgradeMenuBackground()
    --color of box
...
function clickTreeTabCheck(mouseX, mouseY)
    x1 = windowWidth*0.82
    y1 = windowHeight*0.06 - upgradeTabHeight
    x2 = windowWidth*0.82 + upgradeTabWidth
